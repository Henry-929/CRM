	...
	<script>
		...
		$(function () {
			...
			$("#create-stage").change(function () {
				...
				// alert(stage);
				// 没有这种用法
				<%-- var possibility = "${applicationScope.pMap.stage}";--%>
				...
				// alert(possibility);*/
				var mjson = ${applicationScope.mJson};
				var possibility = mjson[stage];
...
<body>
	...
	<form action="workbench/transaction/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="百度1">
				<input type="hidden" value="012fc372f08b452e9c6e75bf02ca4e31" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="02a3e85c2a204fbebcb4bd904f8eabf8" name="contactsId">
			</div>
		</div>
